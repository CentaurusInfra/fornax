...
import (
	"github.com/kubeedge/kubeedge/cloud/cmd/inter_cluster_gateway/pkg/apis/divider/client/clientset/versioned/scheme"
...
func (c *MizarV1Client) Dividers(namespace string) DividerInterface {
	return newDividers(c, namespace)
}
