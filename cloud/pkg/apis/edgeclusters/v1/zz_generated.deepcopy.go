...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatusCheckFields) DeepCopyInto(out *StatusCheckFields) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatusCheckFields.
func (in *StatusCheckFields) DeepCopy() *StatusCheckFields {
	if in == nil {
		return nil
	}
	out := new(StatusCheckFields)
	in.DeepCopyInto(out)
	return out
}
