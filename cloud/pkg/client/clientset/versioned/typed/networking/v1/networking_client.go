...
import (
	v1 "github.com/kubeedge/kubeedge/cloud/pkg/apis/networking/v1"
...
// NetworkingV1Client is used to interact with features provided by the networking.kubeedge.io group.
...
func (c *NetworkingV1Client) Vpcs() VpcInterface {
	return newVpcs(c)
}
