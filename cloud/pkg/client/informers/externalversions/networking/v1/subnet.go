...
import (
	...
	v1 "github.com/kubeedge/kubeedge/cloud/pkg/client/listers/networking/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1().Subnets().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1().Subnets().Watch(context.TODO(), options)
			},
		},
		&networkingv1.Subnet{},
		resyncPeriod,
...
func (f *subnetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1.Subnet{}, f.defaultInformer)
}
